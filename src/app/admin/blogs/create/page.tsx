...
export default function CreateBlogPost() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await blogPostApi.create(
        postData as Omit<BlogPost, "id" | "createdAt" | "updatedAt" | "views">,
      );
  ...
  return (
    <div className="space-y-6">
      <SEO
        ...
        description="Create a new blog post for Royal Furniture"
      />
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white border border-warm-beige p-6 rounded-lg">
                  ...
                  onChange={(e) => {
                    ...
                    if (value.includes(",")) {
                      const items = value
                        ...
                        .filter((item) => item);
                      items.forEach((item) => {
                        if (item && !formData.tags?.includes(item)) {
                          setFormData((prev) => ({
                            ...prev,
                            tags: [...(prev.tags || []), item],
                          }));
              ...
              {(formData.tags || []).length === 0 && (
                <p className="text-[8px] text-gray-400 mt-1">
                  Press Enter or click Add to add tags. Separate with commas for
                  multiple tags.
                </p>
              )}
            </div>
            ...
            <div className="bg-white border border-warm-beige p-6 rounded-lg">
              ...
              <div className="space-y-3">
                ...
                <div>
                      ...
                      onChange={(e) => {
                        ...
                        if (value.includes(",")) {
                          const items = value
                            ...
                            .filter((item) => item);
                          items.forEach((item) => {
                            if (item && !formData.seoKeywords?.includes(item)) {
                              setFormData((prev) => ({
                                ...prev,
                                seoKeywords: [
                                  ...(prev.seoKeywords || []),
                  ...
                  <p className="text-[8px] text-gray-400 mt-1">
                    Separate with commas for multiple keywords
                  </p>
                </div>
              </div>
            </div>
